...
public class TilPostDto {
	...
	public static class Info {
		...
		@Schema(description = "게시물 본문", example = "게시물 본문입니다.")
	...
	public static class Request {
		@Schema(description = "게시글 제목", minLength = 1, maxLength = 50, required = true, example = "게시물 제목입니다.")
		@NotBlank(message = "제목이 비어있습니다.")
		@Size(max=50, message = "최대 길이가 50입니다.")
		private String title;

		@Schema(description = "작성하고자 하는 날짜 -  YYYY-MM-DD 형식", required = true)
		@NotNull(message = "날짜가 비어있습니다.")
		@DateTimeFormat(iso = DateTimeFormat.ISO.DATE)
		private LocalDate date;

		@Schema(description = "게시글 본문", minLength = 1, maxLength = 10000, required = true, example = "게시물 본문입니다.")
